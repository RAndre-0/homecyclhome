...
final class Version20250101173439 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE zone ADD CONSTRAINT FK_A0EBC007E6C5D496 FOREIGN KEY (technician_id) REFERENCES "user" (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE zone DROP CONSTRAINT FK_A0EBC007E6C5D496');
